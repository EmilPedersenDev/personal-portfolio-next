      ...
      <div className={style["about__personal"]}>
        <div className={style["about__info"]}>
          ...
          <div className={style["about__text"]}>
            <p>
              &quot;I&#39;m a developer who thrives on challenging myself and to become better than I was yesterday.
              I&#39;ve spent the last for years in web development, and the creative and fast paced style of frontend is
              something that suits me well.&quot;
            </p>
            <p>
              &quot;My aspirations in the near future is to pivot a bit more into the fullstack sphere. It&#39;s
              something that really intruiges me and i have gotten the opportunity to work more fullstack
              recently.&quot;
            </p>
            <p>
              &quot;When I&#39;m not coding, It&#39;s probably fishing, Pokemon card hunting or being out in the wild
